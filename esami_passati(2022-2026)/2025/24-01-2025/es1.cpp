...
▶ un metodo dequeue che rimuove l’elemento in testa alla coda e lo restituisce. Se la coda `e vuota, il metodo deve
lanciare un’eccezione.
▶ un metodo isEmpty che controlla se la coda `e vuota
